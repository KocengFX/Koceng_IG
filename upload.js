...
(async () => {
    ...
    try {
        ...
        await inputUploadHandle.uploadFile('motivational_quote_output_light_mode.png'); // Ubah dengan path file yang ingin di-upload
        ...
        const captionText = `TAG temen Kamu. 

-
-
-
Hashtags:
#abouthify #writer #writing #quotes #quotesindonesia #quotestagram #quotesgalau #quote #quoteoftheday #quotestagram #quotesdaily #senja #literasi30detik #literasi #literasi15detik #galau #galauquotes #katakatamotivasi #katakatacinta #katabijak #katakata #katamutiara #katamotivasi #sajak #sajakcinta #sajakrindu #sajakdetik #puisi #puisicinta`; // Menggunakan teks terakhir dari file sebagai bagian dari caption
